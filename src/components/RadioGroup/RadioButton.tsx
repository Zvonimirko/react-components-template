...
export const RadioButton = ({
  ...
  if (customRadioButton) {
    return (
      <label
        className={twMerge(
          clsx('relative flex items-center mb-2 last:mb-0', containerClass)
        )}
      >
        <div
          className={twMerge(
        ...
        >
            ...
            <svg
              className={twMerge(
                clsx(
                  ...
                  {
                    [`w-[${customIconDefaultSize}px] h-[${customIconDefaultSize}px]`]:
                      customIconDefaultSize,
                  },
                  customIconClass
                )
          ...
          <div
            className={twMerge(
              clsx('hidden rounded-full absolute inset-0 z-0', activeClass)
            )}
          />
        </div>
        ...
        <div
          className={twMerge(
            clsx('ml-3 text-sm leading-5', labelContainerClass)
          )}
        >
          <span className={twMerge(clsx('text-gray-700', labelClass))}>
            {label}
          </span>
        </div>
      </label>
  ...
  return (
    <div
      className={twMerge(
        clsx('relative flex items-start mb-2 last:mb-0', containerClass)
      )}
    >
        ...
        <input
          className={twMerge(
            clsx(
              ...
              {
                [`text-indigo-600 focus:ring-indigo-500 ${activeClass}`]:
                  activeClass,
              },
      ...
      <div
        className={twMerge(clsx('ml-3 text-sm leading-5', labelContainerClass))}
      >
        <label
          htmlFor={name + value}
          className={twMerge(clsx('text-gray-700', labelClass))}
        >
          {label}
        </label>
      </div>
