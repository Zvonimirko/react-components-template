...
import { DataWithMeta, PaginationContext, SortDirection, TableColumn } from './types';
...
export const Table = <T,>({
  ...
  const {
    currentPage,
    onSortChange: headerClicked,
    onPageChange: pageClicked,
    onPageSizeChange: pageSizeClicked,
  } = paginationContext;
      ...
      <div className="overflow-x-auto overflow-y-auto relative flex-1 bg-white flex flex-col rounded-t-lg">
        ...
        {!isLoading && table.getRowModel().rows.length === 0 && (
          <div className="border-t text-center text-gray-400 font-semibold p-6 flex items-center flex-col flex-1 justify-center">
            <img src="/empty_table.svg" alt="No data to display" className="w-48 mb-10" />
